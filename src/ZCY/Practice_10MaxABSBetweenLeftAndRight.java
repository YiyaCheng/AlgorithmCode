...
/**
 * 题目描述：给定一个长度为N(N>1)的整型数组arr，可以划分成左右两个部分，左部分为arr[0,K]，右部分
 * 		 为arr[K+1..N-1],K可以取值的范围是[0，N-2]。求这么多划分方案中，左部分中的最大值减去
 * 		 右部分最大值的绝对值中，最大是多少？
 ...
 *
 */
public class Practice_10MaxABSBetweenLeftAndRight {
